...
const Cart = () => {
  ...
  let totalPrice = cartItems.reduce((total, item) => {
    ...
    return (
      total +
      ((selectedProduct?.Price) - (selectedProduct?.Price * selectedProduct?.percent) / 100) * item.qty
    );
  }, 0);
        ...
        {cartProducts.length === 0 ? (
          ...
          <>
              ...
              <div>
                <div className="flex items-center gap-[5px]">
                  <div className="flex items-center gap-[5px]">
                    ...
                    <p className="text-[16px] text-[#a1a5a9] font-bold">
                      فروشنده:
                    </p>
                  </div>
                  <div>
            ...
            <div className="mt-[20px] flex justify-between items-center">
              ...
              <Button className="text-white  px-[50px] py-[15px] rounded-[10px]">
