...
const Navbar = () => {
  ...
  return (
    <Container>
      <div className="header flex flex-wrap py-6">
        <div className="w-full flex items-center">
          <div className="w-1/4 flex items-center gap-3">
            ...
            <Link to={"/login"}>
              <Button className="bg-[#19B16A] text-white px-[30px] py-[10px] rounded-[20px]">
                ورود و ثبت نام
              </Button>
            </Link>
          </div>
          <div className="w-1/2 flex justify-center relative">
            ...
            />
            <span className="icon-search absolute top-2.5 right-2.5">
              <svg
        ...
        <div className="w-full flex items-center gap-8 mt-8">
          <div className="flex items-center gap-1 cursor-pointer relative after:content-[''] after:absolute after:top-[110%] after:right-0 after:bg-[#00BF6F] after:w-0 after:h-[3px] after:rounded-full after:transition-all after:duration-200 hover:after:w-full">
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
